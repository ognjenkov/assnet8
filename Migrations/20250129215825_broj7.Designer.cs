...
namespace assnet8.Migrations
{
    ...
    [Migration("20250129215825_broj7")]
    partial class broj7
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("assnet8.Models.Organization", b =>
                {
                    ...
                    b.HasDiscriminator<string>("OrganizationType").HasValue("Organization");
            ...
            modelBuilder.Entity("assnet8.Models.TeamOrganization", b =>
                {
                    b.HasBaseType("assnet8.Models.Organization");
                    ...
                    b.HasDiscriminator().HasValue("TeamOrganization");
                });

            modelBuilder.Entity("assnet8.Models.UserOrganization", b =>
                {
                    b.HasBaseType("assnet8.Models.Organization");
                    ...
                    b.HasDiscriminator().HasValue("UserOrganization");
                });
            ...
            modelBuilder.Entity("assnet8.Models.Service", b =>
                {
                    ...
                    b.HasOne("assnet8.Models.User", null)
                        .WithMany("Services")
                        .HasForeignKey("UserId");
