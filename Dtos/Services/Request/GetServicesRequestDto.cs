...
public class GetServicesRequestDto : PaginationQueryDto
{
    public Guid[]? LocationIds { get; set; }
    public Guid[]? TagIds { get; set; }
}
public class GetServicesRequestDtoValidator : AbstractValidator<GetServicesRequestDto>
{
    private readonly AppDbContext _dbContext;
    private readonly IHttpContextAccessor _httpContextAccessor;
    public GetServicesRequestDtoValidator(AppDbContext dbContext, IHttpContextAccessor httpContextAccessor)
    {
