       ...
       public class ImageConfiguration : IEntityTypeConfiguration<Image>
       {
              public void Configure(EntityTypeBuilder<Image> builder)
              {
                     ...
                     builder.HasOne(i => i.Field)
                            ...
                            .OnDelete(DeleteBehavior.SetNull); // Set ImageId to null in Field when Image is deleted
                     ...
                     builder.HasOne(i => i.Listing)
                            ...
                            .OnDelete(DeleteBehavior.SetNull); // Set ImageId to null in Listing when Image is deleted
                     ...
                     builder.HasOne(i => i.Service)
                            ...
                            .OnDelete(DeleteBehavior.SetNull); // Set ImageId to null in Service when Image is deleted

                     // Configure one-to-one relationship with Team
                     builder.HasOne(i => i.Team)
                            .WithOne(t => t.LogoImage)
                            .HasForeignKey<Team>(t => t.LogoImageId)
                            .OnDelete(DeleteBehavior.SetNull); // Set ImageId to null in Team when Image is deleted
                     ...
                     builder.HasOne(i => i.Organization)
                            ...
                            .OnDelete(DeleteBehavior.SetNull); // Set ImageId to null in Organization when Image is deleted
